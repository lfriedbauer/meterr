...
changes:
  ...
  - date: 2025-08-14
    type: creation
    description: Initial agent definition with comprehensive product design capabilities
    author: system
```

### Version History
- v0.1.0-mvp (2025-08-14): Enhanced with standardized sections and version control
- v0.1.0-mvp (2025-08-14): Initial creation with core product design functionality

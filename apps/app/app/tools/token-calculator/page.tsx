...
export default function TokenCalculator() {
  ...
  const calculateCosts = () => {
    ...
    const results = MODEL_PRICING
      ...
      .map(model => {
        ...
        const percentSaved = subscriptionCost > 0 ? ((savings / subscriptionCost) * 100).toFixed(1) : "0";
        ...
        return {
          ...
          percentSaved,
          recommendation: monthlyCost < subscriptionCost 
  ...
  const getTotalSavings = () => {
    return calculations.reduce((total, calc) => 
      total + parseFloat(calc.savings), 0
    ).toFixed(2);
  };
    ...
    <div style={{ padding: "24px", maxWidth: "1400px", margin: "0 auto", fontFamily: "system-ui" }}>
      ...
      <div style={{ marginBottom: "32px" }}>
        ...
        <p style={{ color: "#64748b", fontSize: "16px" }}>
          Calculate token usage and compare costs across AI providers. Find the most cost-effective model for your needs.
        </p>
      </div>
      ...
      {calculations.length > 0 && (
        <>
          <div style={{ 
            ...
            <h3 style={{ fontSize: "18px", fontWeight: "600", marginBottom: "16px", color: "#14532d" }}>
              💰 Cost Analysis Summary
            </h3>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "16px" }}>
              <div style={{ background: "white", padding: "12px", borderRadius: "6px" }}>
                <div style={{ fontSize: "12px", color: "#64748b", marginBottom: "4px" }}>Best Option</div>
                <div style={{ fontSize: "16px", fontWeight: "600" }}>{getBestOption()?.model}</div>
                <div style={{ fontSize: "14px", color: "#16a34a" }}>${getBestOption()?.monthlyCost}/mo</div>
              </div>
              <div style={{ background: "white", padding: "12px", borderRadius: "6px" }}>
                <div style={{ fontSize: "12px", color: "#64748b", marginBottom: "4px" }}>Total Monthly Savings</div>
                <div style={{ fontSize: "20px", fontWeight: "600", color: "#16a34a" }}>${getTotalSavings()}</div>
              </div>
              <div style={{ background: "white", padding: "12px", borderRadius: "6px" }}>
                <div style={{ fontSize: "12px", color: "#64748b", marginBottom: "4px" }}>Tokens per Call</div>

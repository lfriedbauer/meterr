  ...
  const keyInsights = [
    {
      ...
      description: "Overall AI ROI increased by 23% this week, driven primarily by Customer Support automation.",
      impact: "positive"
    },
    {
      icon: DollarSign,
              ...
              <div key={index} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                      Expected savings: <span className="font-semibold text-green-600">{rec.expectedSaving}</span>
                    </p>
                  </div>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-blue-800 dark:text-blue-200 leading-relaxed">
                ...
                Customer Support is your star performer, achieving 3x returns through efficient automation. 
                The automatic optimization system saved you $2,156 without any quality degradation. 
                However, Marketing needs attention as they&apos;re approaching their budget limit. 
                By implementing the recommended optimizations, you could save an additional $1,180 per month. 
                The trend is positive - your AI efficiency improved 23% compared to last month.
              </p>
            </div>
          </div>
        </div>

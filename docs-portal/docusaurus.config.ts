...
const config: Config = {
  ...
  themeConfig: {
    ...
    metadata: [
      ...
      {name: 'description', content: 'Meterr helps teams save up to 30% on AI costs. Track usage across OpenAI, Anthropic, Google AI. Real-time monitoring, budget alerts, and optimization insights.'},
      {name: 'og:description', content: 'Save up to 30% on AI costs with Meterr. Track, optimize, and manage expenses across all major AI providers.'},
